...
#' )
preprocess_bed <- function(files, names = files, maxlag = 1e5, prefix = "clean_", outdir = tempdir()) {
  tibble::tibble(
    files = files,
    names = names
  ) %>% 
...
```{r function-W}
#' W the uniform kernel of width eta
#'
#' @param x vector of data
#' @param eta witdh of the uniform kernel
#'
#' @return
#' Median of vector x
#' @export
...
eta    = c(1400, 100, 560) # mean interval size for beds
K      = 10
delta  = 10000
