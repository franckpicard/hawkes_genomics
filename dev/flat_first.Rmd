...
compute_hawkes_histogram <- function(
  ...
  cmd <- c(cmd, "-lambda 1")
  system2(
    file.path(find.package(package = "hawkes.genomics"), "bin", "hawkes_bin"),
    cmd,
    stdout = TRUE
  ) |>
  textConnection() |>
...
## preprocess data
  ...
  # files = c(
  #   system.file("extdata", "enhancer.bed", package="hawkes.genomics"),
  #   system.file("extdata", "coding_prom.bed", package="hawkes.genomics"),
  #   system.file("extdata", "sin3peaks.bed", package="hawkes.genomics")
  # ),

```{r, eval = F}
beds <- preprocess_bed(
  # files = c("bed/enhancer.bed", "bed/coding_prom.bed", "bed/sin3peaks.bed"),
  files = c(
    system.file("extdata", "enhancer.bed", package="hawkes.genomics"),
    system.file("extdata", "coding_prom.bed", package="hawkes.genomics"),
    system.file("extdata", "sin3peaks.bed", package="hawkes.genomics")
