...
beds <- preprocess_bed(
  files = c(
    ...
    # system.file("extdata", "oris.bed", package = "hawkesGenomics"),
    # system.file("extdata", "CGI.bed", package = "hawkesGenomics"),
    # system.file("extdata", "G4plus.bed", package = "hawkesGenomics")
    "inst/extdata/soris.bed.gz",
    "inst/extdata/sCGI.bed.gz",
    "inst/extdata/sG4plus.bed.gz"
  ),
