...
fusen::fill_description(
  pkg = "hawkesGenomics",
  fields = list(
    Title = "Hawkes genomics",
    Description = "R wrappers to compute spacial correlogram from bed files.",
    `Authors@R` = c(
      person("Laurent", "Modolo", email = "laurent.modolo@ens-lyon.fr",
        role = c("aut", "cre"), comment = c(ORCID = "0000-0002-7606-4110")),
      person("Franck", "Picard", email = "franck.picard@ens-lyon.fr",
        role = c("aut"), comment = c(ORCID = "0000-0001-8084-5481"))
    ),
    Version = "0.0.1",
    OS_type = "unix",
    SystemRequirements = "cpp/clang, make"
  ),
  overwrite = TRUE
)
...
# Code of Conduct
usethis::use_code_of_conduct("laurent.modolo@ens-lyon.fr")
# NEWS
usethis::use_news_md()
```
